...
/**
 * ========== 易支付-微信支付 by empet 开始 ==========
 * 
 * @link https://github.com/empet/FOSSBilling-Patch  
 * @version v1.0.2
 * 
 * ========== 易支付-微信支付 by empet ==========
 */

class Payment_Adapter_EpayWxpay implements FOSSBilling\InjectionAwareInterface
{
    ...
    public function getHtml($api_admin, $invoice_id, $subscription)
    {
        ...
        $payGateway = $this->di['db']->findOne('PayGateway', 'gateway = "EpayWxpay"');
        ...
        $html .= '<button type="submit" class="btn btn-primary">正在跳转到微信支付页面...</button>';
        $html .= '</form>';
