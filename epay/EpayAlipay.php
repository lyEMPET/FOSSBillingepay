...
class Payment_Adapter_EpayAlipay implements FOSSBilling\InjectionAwareInterface
{
    ...
    public function getHtml($api_admin, $invoice_id, $subscription)
    {
        ...
        $payGateway = $this->di['db']->findOne('PayGateway', 'gateway = "EpayAlipay"');
        ...
        $html .= '<button type="submit" class="btn btn-primary">正在跳转到支付宝支付页面...</button>';
        $html .= '</form>';
